function outWave=pry_waveformToPWM_block_Task(inputWave,inputFrequency,carrierFreq,samplesPerBin)
% outWave=pry_waveformToPWM_block_Task(inputWave,inputFrequency, carrierFreq,samplesPerBin)
...
% inputWave=convertToPWM;
% inputFrequency=expt.stim.temporal.sampleRate;
% carrierFreq=session.analogue.session.Rate;
% samplesPerBin=100;
...
compareWave=kron(resampledInput,ones(samplesPerBin,nChannels)); % Uses the kronecker tensor produt to expand the waveform
