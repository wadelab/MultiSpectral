...
double startTime;
float modulationRateHz[] = {1, 1,1,1,1,1,1}; // Flicker rate of the LEDs when they're on
int LEDamps[] = {0,255,0,255,0,255,0};
int LEDactive[] = {0,1,0,0,1,0,1};
    ...
    for (int thisByte=0;thisByte<7;thisByte++) {
      ...
      double cMillis=(millis()-startTime)/1000.0;
        ...
        for (int thisPinIndex = 0; thisPinIndex < 7; thisPinIndex++) { 
            ...
            analogWrite(ledPins[thisPinIndex], 128*LEDactive[thisPinIndex]*8);
        } // Next pin
