...
theExptID={'LLP'}; %set the experiment IDs you want to test, e.g.: LM, LLP, LPM
...
dpy.NumStimLevels = 3; %the number of levels for the method of constant stim
dpy.NumTrialsPerLevel = 3; %the number of trials for each level
...
for thisCond = 1:TotalNumConds
    ...
    Data=DEMO_MCS_Run_TetraExp_DUE_5LEDs(dpy,s);
