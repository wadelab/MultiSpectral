function stimulus=pry_makeAnalogueStim_block_Task(dpy,session,stim,coneSensors)
% stimulus=pry_makeAnalogueStim(dpy,session,stim,coneSensors)
...
stim.chrom.stimLMS.scale.contrast=modulation*stim.chrom.scale;
 

[LEDStim]= pry_sensor2primary_Task(dpy,stim.chrom,dpy.backRGB,coneSpectra,coneSensors);
